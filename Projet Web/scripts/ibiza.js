document.addEventListener("DOMContentLoaded", function () {
    const activities = [
        { name: "Soirée au Pacha avec table VIP", price: 3200, image: "assets/pacha.jpg" },
        { name: "Croisière privée avec open bar", price: 4500, image: "assets/croisiere.jpg" },
        { name: "Brunch sunset à Cala Bassa Beach Club", price: 1500, image: "assets/cala.jpg" },
        { name: "Pool Party au Ushuaïa", price: 3000, image: "assets/ushuaia.jpg" },
        { name: "Excursion en jetski autour de l'île", price: 2500, image: "assets/jetski.jpg" },
        { name: "Session détente dans un spa face mer", price: 1000, image: "assets/spa.jpg" }
    ];
