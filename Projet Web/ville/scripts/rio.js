document.addEventListener("DOMContentLoaded", function () {
    const activities = [
        { name: "Tour en hélicoptère au-dessus du Christ Rédempteur", price: 5000, image: "assets/bresil/helico.jpg" },
        { name: "Soirée VIP au Copacabana Palace", price: 3500, image: "assets/bresil/copacabana.jpg" },
        { name: "Cours de samba privé avec des pros", price: 800, image: "assets/bresil/samba.jpg" },
        { name: "Excursion en yacht autour des îles", price: 4000, image: "assets/bresil/yacht.jpg" },
        { name: "Session de surf avec moniteur à Ipanema", price: 1200, image: "assets/bresil/surf.webp" },
        { name: "BBQ brésilien sur la plage avec DJ", price: 2500, image: "assets/bresil/bbq.jpg" }
    ];
